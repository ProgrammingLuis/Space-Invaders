...
public class Attack {
	...
	private static Timer enemyShootingTimer;
	...
	public static void enemyShoot(List<JLabel> enemyLasers, JLabel spaceship, JLayeredPane layeredPane, JLabel background, JLabel gameOverLabel, List<JLabel> firstRow, List<JLabel> secThirdRow, List<JLabel> fourthRow) {
		...
		ActionListener task = new ActionListener() {
			...
			enemyShootingTimer = new Timer(20, task);
			enemyShootingTimer.setRepeats(true);
			enemyShootingTimer.start();

	}
	
	/**
	 * Stops the shooting timers to reduce lag.
	 */
	
	public static void stopShootingTimers() {
