...
public class Movement {
	...
	private static Timer enemyMovingTimer;
	
	private static JLabel laser;
	...
	public static void enemyMovement(List<JLabel> firstRow, List<JLabel> secThirdRow, List<JLabel> fourthRow, List<JLabel> enemyLasers) {
		...
		enemyMovingTimer = new Timer(350, task);
		enemyMovingTimer.setRepeats(true);
		enemyMovingTimer.start();

	}
	
	/**
	 * Stops movement timer to reduce lag.
	 */
	public static void stopMovementTimers() {
		...
		spaceship.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				if(e.getKeyCode()== KeyEvent.VK_SPACE){
					...
					laser = new JLabel("Animate.laser");
